      ...
      <nav className="border-b bg-background" data-testid="breadcrumb">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <ol className="flex items-center gap-1.5 text-xs text-muted-foreground flex-wrap" itemScope itemType="https://schema.org/BreadcrumbList">
            ...
            <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              <Link href="/knowledge-hub" className="hover:text-foreground transition-colors" itemProp="item">
            ...
            <ChevronRight className="w-3 h-3" />
            <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              <Link href={`/knowledge-hub?category=${encodeURIComponent(article.category)}`} className="hover:text-foreground transition-colors" itemProp="item">

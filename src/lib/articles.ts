...
export const ARTICLE_CATEGORY_DEFS = [
  { name: "Expert Witness", slug: "expert-witness" },
...
export const ARTICLES: Article[] = [
  {
    ...
    readTime: 8,
    image: "/images/articles/article-expert-witness.png",
    featured: true,
  },
  {
    id: "2",
    ...
    readTime: 10,
    image: "/images/articles/article-ptsd.png",
  },
  {
    id: "3",
    ...
    readTime: 6,
    image: "/images/articles/article-choosing-expert.png",
  },
  {
    id: "4",
    ...
    readTime: 7,
    image: "/images/articles/article-family-law.png",
  },
  {
    id: "5",
    ...
    readTime: 9,
    image: "/images/articles/article-court.png",
  },
  {
    id: "6",
    ...
    readTime: 11,
    image: "/images/articles/article-neuropsych.png",
  },
  {
    id: "7",
    ...
    readTime: 8,
    image: "/images/articles/article-clinical-negligence.png",
  },
  {
    id: "8",
...
export const ARTICLE_CATEGORIES = ARTICLE_CATEGORY_DEFS.map((def) => ({
  ...def,
  count: ARTICLES.filter((a) => a.category === def.name).length,
}));

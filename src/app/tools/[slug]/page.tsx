...
// These slugs have dedicated static routes under /tools/[slug]/page.tsx
// and must not be generated by the dynamic [slug] route.
const DEDICATED_ROUTES = new Set(['legal-assessment', 'psychologist-or-psychiatrist']);
    ...
    return (edges ?? [])
      .filter(
        (edge: any) =>
          ...
          edge.node._sys.filename !== OVERVIEW_FILE &&
          !DEDICATED_ROUTES.has(edge.node._sys.filename)
      )
      .map((edge: any) => ({ slug: edge.node._sys.filename }));
  } catch (e) {
    console.error("[tina] toolsConnection failed (rich-text schema mismatch):", e);
    return [];
  }
}
...
export default async function Page({
  ...
  return (
    <>
      ...
      <section id="checker" className="py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
